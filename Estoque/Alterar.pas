...
type
  TfAlterar = class(TForm)
    ...
    spdbtLimpar: TSpeedButton;
    spdbtCancelar: TSpeedButton;
    procedure spdbtConfirmarClick(Sender: TObject);
    procedure spdbtLimparClick(Sender: TObject);
    procedure spdbtCancelarClick(Sender: TObject);
  private
...
procedure TfAlterar.spdbtConfirmarClick(Sender: TObject);
begin
  banco.table1.edit;
...
procedure TfAlterar.spdbtLimparClick(Sender: TObject);
begin
  edtCod.clear;
  edtProd.clear;
  edtForn.clear;
...
procedure TfAlterar.spdbtCancelarClick(Sender: TObject);
begin
  fAlterar.Close;
end;
